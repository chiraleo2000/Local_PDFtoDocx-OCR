#!/usr/bin/env bash
# ══════════════════════════════════════════════════════════════════════════════
#  LocalOCR — Installer for Linux & macOS  (v1.0.0-beta)
#
#  Usage:
...
echo -e "${BOLD}${CYAN}║   LocalOCR v1.0.0-beta  |  Linux & macOS             ║${RESET}"
echo -e "${BOLD}${CYAN}╚══════════════════════════════════════════════════════╝${RESET}"
echo ""
...
#!/usr/bin/env bash
# LocalOCR launcher — generated by installer v1.0.0-beta
cd "$INSTALL_DIR"
...
<dict>
    ...
    <key>CFBundleVersion</key>             <string>1.0.0-beta</string>
    <key>CFBundleShortVersionString</key>  <string>1.0.0-beta</string>
...
echo -e "${BOLD}${GREEN}║  LocalOCR v1.0.0-beta installed successfully!            ║${RESET}"
echo -e "${BOLD}${GREEN}║                                                          ║${RESET}"
