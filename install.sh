#!/usr/bin/env bash
# ══════════════════════════════════════════════════════════════════════════════
#  LocalOCR — Installer for Linux & macOS  (v0.4.0)
#
#  Usage:
...
echo -e "${BOLD}${CYAN}║   LocalOCR v0.4.0        |  Linux & macOS             ║${RESET}"
echo -e "${BOLD}${CYAN}╚══════════════════════════════════════════════════════╝${RESET}"
echo ""
...
#!/usr/bin/env bash
# LocalOCR launcher — generated by installer v0.4.0
cd "$INSTALL_DIR"
...
echo -e "${BOLD}${GREEN}║  LocalOCR v0.4.0 installed successfully!                  ║${RESET}"
echo -e "${BOLD}${GREEN}║                                                          ║${RESET}"
